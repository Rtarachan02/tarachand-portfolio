...
> **Status: Phase 1 — Architecture & Scaffolding.** The repo skeleton, backend/frontend shells, and local Docker Compose environment are in place. Auth, content models, and the full UI are being built out in subsequent phases. See [docs/](docs/) as it grows for architecture and API details.
...
2. ⬜ Backend core (config, logging, error handling)
3. ⬜ Database schema & migrations
4. ⬜ Frontend core (routing, theme, layout)
5. ⬜ Authentication (JWT + Google/GitHub OAuth)
6. ⬜ Interactive UI (3D visualizations, animations, showcase pages)
7. ⬜ Deployment (Docker, Render)
